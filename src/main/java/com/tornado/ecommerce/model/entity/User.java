...
public class User extends BaseEntity {
	...
	@ManyToMany
	@JoinTable(name = "ecommerce_role_ecommerce_user", 
			joinColumns = @JoinColumn(name = "ecommerce_user", referencedColumnName = "recid"), 
			inverseJoinColumns = @JoinColumn(name = "ecommerce_role", referencedColumnName = "recid"))
